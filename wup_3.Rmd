...
```
  According to the chart, the back row drinks 9.6 more alcoholic drinks than the middle row, drinking only about 3.2 alcoholic drinks per week. The front row drinks 1.8 per week. It is reasonable to assume that the amout being drank per week is not the same between these 3 rows.
